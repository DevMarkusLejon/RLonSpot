...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.0, noise_range=(0.02, 0.05), noise_step=0.02, border_width=0.25
        ),
    },
)
...
class SpotEventCfg:
    ...
    reset_base = EventTerm(
        ...
        params={
            ...
            "pose_range": {"x": (-0.5, 0.5), "y": (-0.5, 0.5),"z":(0.07,0.3), "yaw": (-3.14, 3.14)},
            "velocity_range": {
                "x": (-1.5, 1.5),
                "y": (-1.0, 1.0),
                "z": (-0.5, 0.5),
...
class SpotRewardsCfg:
    ...
    stand_height_error = RewTerm(
        ...
        weight=-7.0,
        params={"asset_cfg": SceneEntityCfg("robot"), "target_height": 1.3}, #previous height target was 0.55 
    )
...
class SpotTerminationsCfg:
    ...
    body_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=["base", ".*uleg", "arm0.*"]), "threshold": 5.0},
    )
    #Codex did this
