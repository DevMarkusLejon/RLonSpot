...
SPOT_ARM_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(0.0, 0.0, 0.65),
        rot=(0,0,1,0), # quaternior rotation needed for robot to be right side up but this solution gives deploy issues
        joint_pos={
            # otbit order
            "fl_hx": 0.1,
            "fr_hx": -0.1, 
            ...
            "hr_kn":-1.5,
            "arm0_sh0": 0, #-150°/180° 
            "arm0_sh1": -3.13, # -180°/30° 
            "arm0_el0": 3.13, # 0°/180° 
            "arm0_el1": 1.56,#0, # -160°/160° 
            "arm0_wr0": 0, # -105°/105°
            "arm0_wr1": -1.56,#0, # -165°/165°
            "arm0_f1x": 0, #-90°/0°
        },
        joint_vel={".*": 0.0},
    ),
...
SPOT_ARM_BDAIFEET_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        asset_path="/workspace/isaaclab/source/isaaclab_assets/data/own_assets/assets_with_feet/spot/spot_with_arm.urdf", # make sure this path is correct
        fix_base=False,
